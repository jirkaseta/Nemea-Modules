...
int Field_template::set_templates(const Field_type ag_type, const ur_field_type_t ur_f_type)
{
    ...
    case APPEND:
        ...
        case UR_TYPE_A_MAC:    return assign_append<mac_addr_t>();
...
int Field_template::set_templates(const ur_field_type_t ur_f_type, const ur_field_type_t ur_sort_key_f_type)
{
    ...
    case UR_TYPE_A_MAC:
        switch (ur_sort_key_f_type) {
        case UR_TYPE_A_UINT8:  return assign<mac_addr_t, uint8_t>();
        case UR_TYPE_A_INT8:   return assign<mac_addr_t, int8_t>();
        case UR_TYPE_A_UINT16: return assign<mac_addr_t, uint16_t>();
        case UR_TYPE_A_INT16:  return assign<mac_addr_t, int16_t>();
        case UR_TYPE_A_UINT32: return assign<mac_addr_t, uint32_t>();
        case UR_TYPE_A_INT32:  return assign<mac_addr_t, int32_t>();
        case UR_TYPE_A_UINT64: return assign<mac_addr_t, uint64_t>();
        case UR_TYPE_A_INT64:  return assign<mac_addr_t, int64_t>();
        case UR_TYPE_A_FLOAT:  return assign<mac_addr_t, float>();
        case UR_TYPE_A_DOUBLE: return assign<mac_addr_t, double>();
